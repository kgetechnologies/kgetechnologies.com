...
<?php   
   ...
   include('includes/db_config.php');
    ...
    $message=$fullname=$phone=$email=$city='';

    $errors=array('fullname'=>'','phone'=>'','email'=>'','city'=>'','radio'=>'');
      ...
      if(array_filter($errors)){
        ...
        if($responseKeys["success"]) {
              ...
              $data=[
               ...
               'phone'=>$phone,
               'city'=>$city,
               'current_pos'=>$laptop_availabality
...
<div class="form-body">
    ...
    <input type="text"  name="city" value="<?php echo htmlspecialchars($city) ?>" class="form-control" id="city">
     <p class="text-warning"><?php echo $errors['city']; ?></p>


     <input name="radio" type="radio" value="in College" id="inc">
    <label for="inc">In College</label> 

  
     <input name="radio" type="radio" value="Working" id="work">
    <label for="work">working</label> 

     <input name="radio" type="radio" value="searching job" id="sj">
    <label for="sj">searching job</label> 

     <input name="radio" type="radio" value="doing Internship" id="di">
    <label for="di">Doing internship</label> 
