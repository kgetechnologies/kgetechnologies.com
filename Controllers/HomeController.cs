...
namespace kgetechnologies.com.Controllers
{
    ...
    public class HomeController : Controller
    {
        public ActionResult Index(string id = "")
        {
            ...
            if (string.IsNullOrEmpty(id) || !id.Contains("-internship-in-"))
            {
                var LocationLink = InternshipAreas.Select(f => LocationLinks("India", f.Trim())).ToList();
        ...
        public string BuildUrl(string City, string Internship)
        {
        ...
        public List<String> InternshipAreas
        {
            get
            {
                return new List<string>() { "AWS", "Azure", "Google", "Android", "IOS", "Flutter", "Html Bootstrap", "Web Development",
